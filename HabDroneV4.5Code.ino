...
// This logger collects and stores GPS and temperature data
// Easily customizable for other data collectio
...
void setup()
{
  ...
  myFile.println(F("High Altitude Balloon and Drone Logger"));
  ...
  myFile.println();
  myFile.println(F("Sats HDOP Latitude   Longitude   Fix  Date       Time     Date Alt    Course Speed Card    Chars Sentences Checksum"));
...
void loop()
{
  ...
  smartDelay(1000); //Additional sensors may be added
